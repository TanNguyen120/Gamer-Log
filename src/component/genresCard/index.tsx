...
export default function GenresCard({ genresData }: { genresData: any }) {
  return (
    <div className='flex flex-col bg-neutral-800 hover:bg-neutral-700  rounded-lg border border-slate-600'>
      <Link href={`/genres/${genresData.slug}/games`}>
        <Suspense fallback={<p>Loading Image...</p>}>
          <Image
            src={genresData.image_background}
            width={480}
            height={270}
            alt={genresData.name}
      ...
      <Link
        href={`/genres/${genresData.slug}/games`}
